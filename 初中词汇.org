...
- v. 
  - a. ~ about 关心；关爱；在乎
  - b. ~ for sb ＝ take care of = look after  照顾 \\
...
- v. (caught;caught/ko:t/)
  ...
  - ~ a bus   赶上车
  - ~ (a) cold  患感冒
  - Pardon? I didn't ~ you. = understand 对不起，我没明白你的意思。
*** cause
\fillin[cause] /ko:z/
- n. [pl.-s]  原因；起因
  - investigate the ~ of the fire 调查火因
- v. 促使；导致···发生；引发（问题）
  - a. ~ sb to do sth ＝ make/let/have + sb + do sth
...
- n. [pl.-s] (－ter AmE.) 中心；中央
  - in the ~ of = in the middle of
*** century
\fillin[century] /'sentfəri/
- n.  世纪；百年
  - in the twentieth/twenty first ~
*** certainly
...
- n. [pl.-s] 变化；找零
  ...
  - Here's your ~. 请拿好您的零钱。
- v. 变化；改变
  - Shanghai has greatly ~d in recent 20 years.  近20年来，上海变化巨大。
*** changeable
\fillin[changeable] /'tfeind3əbl/
- adj. 多变的
  - ~ weather 变化无常的天气
*** channel
...
- n. [U] 主管；掌管
  - be in ~ of = take ~ of = be responsible for
*** charity
...
\fillin[check] /tfek/
- v. 检查；核对；查看
  - Check the homework before you hand it in. = Examine 先检查作业再交。
  - Check if the windows are all closed. 查看窗户是否都关好了。
- n. 检查；支票；账单
  - have a health ~  体检
...
*** choose
\fillin[choose] /tfu:z/
- v. (chose/tfəuz/;chosen/'tfəuzn/) 选择；挑选；决定
  - ~ (to do) sth  决定（不）做
*** Christmas
...
\fillin[clock] /klok/
- n. [pl.-s] 钟
  - The ~ is five minutes fast/slow.  此钟快／慢了5分钟。
*** close
\fillin[close] /kləuz/
- v.    关；闭
- adj.  靠近的；亲密的；相近的
...
- n. [pl.-s]  颜色
- v.  (用蜡笔、彩笔）涂色；着色
  - Nick drew a tree and ~ed it green.
*** come
\fillin[come] /kAm/
- v. (came,come) 来；来到
...
- adj.  普通的；常见的；共同的；共有的
  ...
  - ~ wish  共同的愿望
  - It's ~ sense that the Earth goes around the Sun. 地球绕太阳转是常识。
*** communicate
\fillin[communicate] /kə'mju:nikeit/
- v. 交流；交往
  - ~ with sb  与···交流、交往
  - ~ one's ideas to sb  传达；传递（思想）
...
- v.  竞争；竞赛
  - ~ with sb
*** competition
\fillin[competition] /kompt'tfn/
- n. [pl.-s]   竞赛；竞争
*** complain
\fillin[complain] /kəm'plen/
- v. (complaint n.) 抱怨；投诉
  - ~ to sb about sth  因···向···投诉
*** complete
\fillin[complete] /kam'pli:t/
- adj.  完整的；完全的
- v.  =finish  完成；完工
...
\fillin[completely]
- adv.   （强调）完全地；彻底地
  - The village uas ~ destroved by the flood.  那个村庄被洪水彻底冲毁了。
*** computer
...
- n. [pl.-s]  音乐会
  - hold/go to a ~  举办／出席···
*** conclusion
\fillin[conclusion] /kan'klu:3n/
- n. (conclude v.)  结论；结局；结束
  - draw the ~ that...  得出结论···
  - The meeting came to ~ yesterday.  会议昨天结束了。
*** conference
...
*** congratulations
\fillin[congratulations] /kən.graet fu'lerjnz/
- n.  (congratulate,v.)[C,always pl.]  祝贺；恭喜
*** connect
\fillin[connect] /kə'nekt/
- v.  连接；把···联系起来
  - ~ A + to / with + B
    - My computer is ~ed to / with the Internet. \\
    ＝be linked to/with... 我的电脑联网了。
*** consider
\fillin[consider] /kən'sidə/
- v.  考虑；认为；视为
  - ~ + doing sth =think about  考虑做
  - ~ sb + (as/to be) sb/sth  把···视为
*** consist of
\fillin[consist of] /kən'sist/
- v. 由···组成、构成
...
*** convenient
\fillin[convenient] /kən'vi:niənt/
- adj.   便利的；方便的
*** conversation
...
- v.  (cost; cost)   (商品）值（···钱）；花费···(钱）
  - 比较：The book cost me $30. \\
    = The book was worth $ 30. \\
    = I spent $30 on/buying the book. \\
    = I paid $30 for the book.
*** cotton
\fillin[cotton] /'kotn/
- n. [U]  棉花
...
\fillin[cough] /kpf/
- v.,n.   咳嗽
  - I've got a bad cold and can't stop ~ing. 我得了重感冒，不停地咳嗽。
  - Miss Li gave a ~ to attract my attention.  李老师咳了一声以引我注意。
*** count
\fillin[count] /kaunt/
- v.  数数；计数
*** country
...
- n.  十字架；叉叉
- v. 穿过（平面）；横渡（河流）
  - ~ the street =come across
*** crowd
\fillin[crowd] /kraud/
- n.  [pl.-s] 人群
  - a large/small ~ of people   一大／小群人
*** crowded
...
- adj.  危险的；
  - It's ~ (for us) to do sth.  有危害的
*** dare
\fillin[dare] /dcə/ 
- action v.,modal v.   敢于；胆敢 \\
  行为v. :: ~ + (to) do sth
  情态v. :: ~ + do sth
  - 行为 v. :: Tom dares (to) go out at night.
